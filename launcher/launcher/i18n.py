...
ZH_TO_EN = {
    ...
    "语音路由": "Speech routing",
    "提供者配置": "Provider settings",
    "火山引擎豆包语音 V3": "Volcano Engine Doubao Speech V3",
    "默认音色": "Default voice",
    "Speaker / 音色 ID": "Speaker / voice ID",
    "资源 ID": "Resource ID",
    "采样率": "Sample rate",
    "支持格式": "Supported formats",
    "健康检查路径": "Health check path",
    "请求超时（秒）": "Request timeout (seconds)",
    "支持音色列表": "Supports voice listing",
    "支持语速": "Supports speed",
    "支持音高": "Supports pitch",
    "支持情绪": "Supports emotion",
    "支持时间轴": "Supports timelines",
